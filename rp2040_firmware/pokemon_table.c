...
#include <stdio.h>  // For printf (for furi_crash stub)

// Flipper specific includes removed
// #include <gui/icon.h>
// #include <furi.h>
// #include <pokemon_icons.h>
// #include <src/include/pokemon_attribute.h> // Contains GenderRatio, will define locally
...
// Basic assertion/crash replacements (if not already defined elsewhere)
#ifndef furi_assert
...
// Copied from Flipper Zero's pokemon_attribute.h as it's used in the table
typedef enum {
    GENDER_F0 = 0, // 0% F, 100% M
    GENDER_F12_5 = 31, // 12.5% F, 87.5% M
    GENDER_F25 = 63, // 25% F, 75% M
    GENDER_F50 = 127, // 50% F, 50% M
    GENDER_F75 = 191, // 75% F, 25% M
    GENDER_F100 = 254, // 100% F, 0% M
    GENDER_UNKNOWN = 255, // Genderless
} GenderRatio;
